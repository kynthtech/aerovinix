...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* HEADER */}
      <section
        className="page-header py-20 bg-cover bg-center relative"
        style={{
      ...
      {/* BODY (Form + Map) */}
      <section
        className="page-contact-us py-20 bg-black bg-cover bg-center relative"
        style={{
          backgroundImage: "url('/images/bg.png')",
        }}
      >
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="mx-auto max-w-4xl text-4xl font-bold text-white">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            {/* Contact Form */}
            <div className="rounded-xl bg-gray-900 p-8 shadow-xl border border-gray-800">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <input
                    ...
                    required
                    className="w-full rounded bg-gray-800 border border-gray-700 px-4 py-3 text-white placeholder-gray-400 focus:border-indigo-500 focus:outline-none"
                  />
                  <input
                    type="text"
                    name="lname"
            ...
            {[
              {
                icon: "icon-phone.svg",
                title: "contact us",
                items: ["(+00) 123-254-963", "(+12) 761 852 339"],
              },
              {
                icon: "icon-mail.svg",
                title: "email us",
                items: ["info@aeravionix.com", "support@aeravionix.com"],
              },
              {
                icon: "icon-clock.svg",
                title: "Working hours",
                items: ["Mon - Fri : 08AM - 10PM", "sat - sun : close"],
              },
              {
                icon: "icon-location.svg",
                title: "location",
                items: ["2715 Ash San Jose, USA", "2715 Ash San Jose, USA"],
              },
            ].map((info, i) => (
              <div
                key={i}
                className="flex gap-4 rounded-xl bg-gray-900 p-6 shadow-lg border border-gray-800"
              >
                <img
